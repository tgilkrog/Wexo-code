...
class MovieController
{
    ...
    public function getMoviesByGenreAndPage($id, $page)
    {
        // Fetch movies by genre id
        $movies = $this->model->getMoviesByGenreAndPage($id, $page);
    ...
    public function showMoviesFrontPage()
    {
        ...
        $movies = [
            ...
            [
                ...
                'genre_id' => 35,
                'movies' => $comedy,
                'total_pages' => $comedy['total_pages']
            ],
            [
                'genre_name' => 'Thriller',
                'genre_id' => 53,
                'movies' => $thriller,
                'total_pages' => $thriller['total_pages']
            ],
            [
                'genre_name' => 'War',
                'genre_id' => 10752,
                'movies' => $war,
                'total_pages' => $war['total_pages']
            ],
            [
                'genre_name' => 'Romance',
                'genre_id' => 10749,
                'movies' => $romance,
                'total_pages' => $romance['total_pages']
            ],
            [
                'genre_name' => 'Drama',
                'genre_id' => 18,
                'movies' => $drama,
                'total_pages' => $drama['total_pages']
            ],
            [
                'genre_name' => 'Crime',
                'genre_id' => 80,
                'movies' => $crime,
                'total_pages' => $crime['total_pages']
            ],
            [
            ...
            [
                ...
                'genre_id' => 27,
                'movies' => $horror,
                'total_pages' => $horror['total_pages']
            ]
        ];
