...
class MovieModel
{
    ...
    public function getMoviesByGenreAndPage($genre_id, $page)
    {
        // Construct the URL for the API request to get movies by genre
        $url = $this->apiUrl . 'discover/movie' . '?api_key=' . $this->apiKey . '&with_genres=' . $genre_id . '&page='.$page.'&include_adult=false';
